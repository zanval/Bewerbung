...
%Wenn man bei eintragL eine Stadt angibt, MUSS man \vspace{-6px} im body davon angeben, weil sonst der Offset Async ist.
...
\section{Schulbildung}
  \eintragL{\zeit[09.1992-01.2000]}{Willi-Gymnasium}{Abitur}{Stadt}{
    \vspace{-6px}
    Bla bla
  }
...
\section{Weitere Tätigkeiten}
  ...
  \eintragL{\zeit[09.2003-02.2004]}{...}{}{...}{
    \vspace{-6px}
    \strut Gewähltes Mitglied des ...
  }
...
\section{IT--Kenntnisse}
  \eintragKb{}{\begin{tabu} to \maincolumnwidth {p{\tabBreite}@{\hspace{\tabSpace}}X{l}}
	  {\mdseries Betriebssysteme}: & Windows, Linux\\[0.2em]
	  {\mdseries Office}: & PowerPoint, \LaTeX \\[0.2em]
	  {\mdseries ...}: & ...\\[0.2em]
	  {\mdseries ...}: & ...\\[0.2em]
	  {\mdseries ...}: & ...
  \end{tabu}
...
\section{Fremdsprachen}
  \eintragKb{}{\begin{tabu} to \maincolumnwidth {p{\tabBreite}@{\hspace{\tabSpace}}X{l}}
	  {\mdseries Englisch}: & verhandlungssicher\\[0.2em]
	  {\mdseries ...}: & ...\\[0.2em]
	  {\mdseries ...}: & ...
  \end{tabu}
  }
